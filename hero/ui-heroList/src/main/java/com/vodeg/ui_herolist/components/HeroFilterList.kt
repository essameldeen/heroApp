package com.vodeg.ui_herolist.components
...
import com.vodeg.ui_herolist.R
import com.vodeg.ui_herolist.ui.*
...
fun HeroListFilter(
    ...
    heroAttribute: HeroAttribute = HeroAttribute.Unknown,
    onUpdateHeroFilterAttribute: (HeroAttribute) -> Unit,
                ...
                item {
                    Column(
                        ...
                        ProWinsFilterSelector(
                            ...
                            isEnabled = heroFilter is HeroFilter.ProWin,
                            order = if (heroFilter is HeroFilter.ProWin) heroFilter.order else null,
                            orderDesc = {
                                onUpdateHeroFilter(
                                    HeroFilter.ProWin(
                                        order = FilterOrder.Descending
                        ...
                        PrimaryAttrFilterSelector(
                            removeFilterOnPrimaryAttr = {
                                onUpdateHeroFilterAttribute(HeroAttribute.Unknown)
                            },
                            attribute = heroAttribute,
                            onFilterStr = {
                                onUpdateHeroFilterAttribute(
...
fun ProWinsFilterSelector(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = HeroFilter.ProWin().uiValue,
                style = MaterialTheme.typography.h3,
            )
        }
